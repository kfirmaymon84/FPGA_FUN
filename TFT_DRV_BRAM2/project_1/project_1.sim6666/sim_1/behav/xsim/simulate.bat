...
REM
REM Generated by Vivado on Sun Jun 23 09:09:28 +0300 2024
...
call xsim  design_tb_behav -key {Behavioral:sim_1:Functional:design_tb} -tclbatch design_tb.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
