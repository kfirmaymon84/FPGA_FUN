...
HD_PWD='C:/FPGA/FPGA_FUN/GraviTris/GraviTris.runs/design_1_rst_clk_wiz_0_16M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_16M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_16M_0.tcl
