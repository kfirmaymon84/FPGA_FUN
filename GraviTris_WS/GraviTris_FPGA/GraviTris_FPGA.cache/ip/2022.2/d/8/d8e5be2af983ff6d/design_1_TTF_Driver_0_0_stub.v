...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, nEnable, ready, start, override, DC_in, WRX_in, 
  ...
  memoryData, dbg_out)
/* synthesis syn_black_box black_box_pad_pin="clk,nEnable,ready,start,override,DC_in,WRX_in,tftData_in[7:0],DC_out,WRX_out,tftData_out[7:0],memoryWriteEN,memoryWriteClk,memoryAddress[14:0],memoryData[7:0],dbg_out[3:0]" */;
  input clk;
  input nEnable;
  output ready;
  input start;
