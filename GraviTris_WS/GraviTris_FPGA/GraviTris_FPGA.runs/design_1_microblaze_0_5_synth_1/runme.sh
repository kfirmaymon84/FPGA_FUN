...
HD_PWD='C:/FPGA/FPGA_FUN/GraviTris_WS/GraviTris_FPGA/GraviTris_FPGA.runs/design_1_microblaze_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_microblaze_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_microblaze_0_5.tcl
